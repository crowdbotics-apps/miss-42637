"""
Django settings for miss_42637 project.
...
WSGI_APPLICATION = 'miss_42637.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "miss_42637 API",
    "DESCRIPTION": "API documentation for miss_42637 App",
    "VERSION": "v1",
}
